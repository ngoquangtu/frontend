...
const MostEnrollmentCoursePage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`https://${process.env.REACT_APP_LOCALHOST}:${process.env.REACT_APP_PORT}/api/courses/mostenrollment`, {
          method: 'POST',
          headers: {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl font-bold mb-6 text-[#12B7BD]">Most Enrollment Courses</h1>
...
export default MostEnrollmentCoursePage;
